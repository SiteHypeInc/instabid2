...
async function calculateTradeEstimate(trade, data, hourlyRate, state, msa, contractorId = null) {
  ...
  // ============================================
  // LOAD CONTRACTOR-SPECIFIC PRICING
  // ============================================
  ...
  switch(trade.toLowerCase()) {
    ...
    case 'painting':
      ...
      materialCost = (gallonsNeeded * paintUnitCost) + primerCost + 125;
    ...
    case 'hvac':
      ...
      materialCost = equipmentBaseCost * sizeMultiplier + 350 + 50 + 150;
    ...
    case 'plumbing':
      ...
      if (plumbServiceType === 'fixture') {
        ...
        materialCost = pipeFeet * 2.50 * 1.3 + 100;
    ...
    case 'drywall':
      ...
      if (drywallServiceType === 'installation') {
        ...
        materialCost = (sheetsNeeded * 15) +
                       (Math.ceil(adjustedDrywallSqft / 200) * 18) +
                       (Math.ceil(adjustedDrywallSqft / 300) * 8) +
                       (Math.ceil(sheetsNeeded / 10) * 12) +
                       50;
    ...
    case 'siding':
      ...
      materialCost += sidingSqft * 0.75 + 150;
  ...
  // Apply contractor markup if set
